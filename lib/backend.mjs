...
const WORLD_NEWS_SEARCH_TEXT =
  "Tamil Nadu Legislative Assembly Tamil Nadu assembly proceedings session debate question hour zero hour demand for grants bill resolution budget policy note welfare scheme governance manifesto minister statement";
...
export async function handleAssemblyNewsRequest(_req, res) {
  ...
  try {
    ...
    sendJson(res, 502, {
      ...
      details: message.includes("Too many concurrent requests")
