...
const WORLD_NEWS_SEARCHES = [
  "Tamil Nadu Legislative Assembly proceedings debate question hour zero hour bill resolution demand for grants",
  "Tamil Nadu assembly budget policy note welfare scheme governance manifesto minister statement",
];
...
async function getAssemblyNews(apiKey) {
  ...
  const englishArticles = queryResults.flat();
